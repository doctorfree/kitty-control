...
**[Note:]** this is a customized Kitty configuration derived from
https://github.com/ttys3/my-kitty-config with modifications from
https://github.com/anhoder/my-kitty-config specifically tailored
for use with `kitty-control`.
